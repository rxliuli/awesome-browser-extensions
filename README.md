...
- [uBlock Origin Lite](https://github.com/uBlockOrigin/uBOL-home) - Permission-less, MV3-native content blocker from the author of uBlock Origin. The recommended way to block ads everywhere the full uBlock Origin can't run — Chrome and Edge after the Manifest V2 shutdown, and Safari.<br>[Chrome](https://chromewebstore.google.com/detail/ublock-origin-lite/ddkjiahejlhfcafbddmgiahcphecmpfh) · [Safari](https://apps.apple.com/us/app/ublock-origin-lite/id6745342698) · [Edge](https://microsoftedge.microsoft.com/addons/detail/ublock-origin-lite/cimighlppcgcoapaliogpjjdehbnofhn) · [Source](https://github.com/uBlockOrigin/uBOL-home)
